...
git checkout -b copilot/<type>/<short-slug>
```

**Branch naming convention:**
| Prefix | When to use |
|--------|-------------|
| `copilot/feat/<slug>` | New features |
| `copilot/fix/<slug>` | Bug fixes |
| `copilot/test/<slug>` | Adding/updating tests |
| `copilot/refactor/<slug>` | Refactoring |
| `copilot/docs/<slug>` | Documentation changes |
| `copilot/infra/<slug>` | Infrastructure/DevOps |

Use lowercase kebab-case for the slug. Keep it short but descriptive (e.g., `copilot/feat/add-user-auth`, `copilot/fix/cors-header-missing`).
